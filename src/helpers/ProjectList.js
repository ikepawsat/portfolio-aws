...
export const ProjectList = [
    {
        name: "Encryption App",
        image: encrypt,
        desc: "Built a desktop app that applied my knowledge of video Encryption and SVD Compression",
        long_desc: "I wanted to test some of the ideas of SVD Video Compression that I had learned in my Data Science class along with some of the encryption teachings I had received a semester prior.",
    ...
    },
    {
        ...
        long_desc: "This is single handedly the most important project of my career so far. I learned the importance of backups (almost having my entire project deleted), how to create scalable neural networks and save them, how to train AI incrementally, and the patience required with these AI.",
